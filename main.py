...
def main():
    ...
    #Run a loop till 'DONE' is read
    while(input_codes!='DONE'):
        

        # Prompt the user to enter product codes separated by commas
        input_codes = input("Enter product codes separated by commas (e.g., GR1,SR1,CF1) or type 'DONE' to finnish: ").strip().upper()
